...
export default function App() {
  ...
  const handleAddOrUpdateProduct = async (e) => {
    ...
    try {
      if (editingProduct) {
        ...
        const productDocRef = doc(db, `/artifacts/${typeof __app_id !== 'undefined' ? __app_id : 'default-app-id'}/public/data/products`, editingProduct.id);
        await updateDoc(productDocRef, productData);
        setEditingProduct(null); // Clear editing state
      } else {
        // Add new product
        const productsCollectionRef = collection(db, `/artifacts/${typeof __app_id !== 'undefined' ? __app_id : 'default-app-id'}/public/data/products`);
        await addDoc(productsCollectionRef, { ...productData, timestamp: new Date().toISOString() });
      }
  ...
  const confirmDelete = async () => {
    ...
    try {
      const productDocRef = doc(db, `/artifacts/${typeof __app_id !== 'undefined' ? __app_id : 'default-app-id'}/public/data/products`, productToDelete.id);
